import { BranchScopeProps, CommonProps, ProjectScopeProps, OrgScopeProps } from '../types.js';
...
export const fillSingleOrg = async (props: CommonProps & Partial<Pick<OrgScopeProps, 'orgId'>>) => {
  if (props.orgId) {
    return props;
  }
