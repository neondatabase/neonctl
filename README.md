...
| `launch`                                                                   |                                                                                             | Provision the stack defined in `neon.ts` (branch-aware app provisioning — see [examples/neon-launch-vercel](./examples/neon-launch-vercel) for a working Next.js + Drizzle + Vercel demo). Requires Node 22+. |
